...
func createMockArgsMultiversXProxy(httpClient erdgoHttp.Client) ArgsMultiversXProxy {
	return ArgsMultiversXProxy{
...
func TestNewMultiversXProxy(t *testing.T) {
	t.Parallel()

	t.Run("invalid time cache should error", func(t *testing.T) {
		t.Parallel()

		args := createMockArgsMultiversXProxy(nil)
		args.CacheExpirationTime = time.Second - time.Nanosecond
		proxy, err := NewMultiversXProxy(args)
...
func TestGetAccount(t *testing.T) {
	...
	args := createMockArgsMultiversXProxy(httpClient)
	args.FinalityCheck = true
	proxy, _ := NewMultiversXProxy(args)
...
func TestMultiversXProxy_GetNetworkEconomics(t *testing.T) {
	t.Parallel()
...
func TestMultiversXProxy_RequestTransactionCost(t *testing.T) {
	t.Parallel()
...
func TestMultiversXProxy_GetTransactionInfoWithResults(t *testing.T) {
	t.Parallel()
...
func TestMultiversXProxy_ExecuteVmQuery(t *testing.T) {
	t.Parallel()
...
func TestMultiversXProxy_GetRawBlockByHash(t *testing.T) {
	t.Parallel()
...
func TestMultiversXProxy_GetRawBlockByNonce(t *testing.T) {
	t.Parallel()
...
func TestMultiversXProxy_GetRawMiniBlockByHash(t *testing.T) {
	t.Parallel()
...
func TestMultiversXProxy_GetNonceAtEpochStart(t *testing.T) {
	t.Parallel()
...
func TestMultiversXProxy_GetRatingsConfig(t *testing.T) {
	t.Parallel()
...
func TestMultiversXProxy_GetEnableEpochsConfig(t *testing.T) {
	t.Parallel()
...
func TestMultiversXProxy_GetGenesisNodesPubKeys(t *testing.T) {
	t.Parallel()
...
func TestMultiversXProxy_GetValidatorsInfoByEpoch(t *testing.T) {
	t.Parallel()
