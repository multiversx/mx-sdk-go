...
import (
	...
	testsInteractors "github.com/multiversx/mx-sdk-go/mx-sdk-go-old/testsCommon/interactors"
...
func createMockTransactionsWithGetNonce(
	...
	for i := 0; i < numTxs; i++ {
		...
		tx.Value = "1"
		tx.Receiver = addr.AddressAsBech32String()
		tx.Sender = addr.AddressAsBech32String()
		tx.GasLimit = 50000
		tx.Data = nil
		tx.Signature = "sig"
		tx.ChainID = "3"
