...
func TestDoGeneratePrivateKeyAsHex(t *testing.T) {
...
func TestDoGeneratePublicKeyAsHex(t *testing.T) {
...
func TestDoComputeMessageSignatureAsHex(t *testing.T) {
	t.Run("with good input", func(t *testing.T) {
	...
	t.Run("with bad input (not hex)", func(t *testing.T) {
		signatureHex := doComputeMessageSignatureAsHex("not hex", "7cff99bd671502db7d15bc8abc0c9a804fb925406fbdd50f1e4c17a4cd774247")
		require.Equal(t, "", signatureHex)
	})

	t.Run("with bad input (bad key)", func(t *testing.T) {
		messageHex := hex.EncodeToString([]byte("hello"))
		signatureHex := doComputeMessageSignatureAsHex(messageHex, "7cff99bd671502db7d15bc8abc0c9a804fb925406fbdd50f1e4c17a4cd7742")
		require.Equal(t, "", signatureHex)
	})
}

func TestDoVerifyMessageSignature(t *testing.T) {
	t.Run("with good input", func(t *testing.T) {
		...
		require.True(t, doVerifyMessageSignature(publicKeyHex, messageHex, signatureHex))
	})
	...
	t.Run("with altered signature", func(t *testing.T) {
		...
		require.False(t, doVerifyMessageSignature(publicKeyHex, messageHex, signatureHex))
	})
...
func TestGenerateSignAndVerify(t *testing.T) {
	...
	signatureHex := doComputeMessageSignatureAsHex(messageHex, privateKeyHex)
	isOk := doVerifyMessageSignature(publicKeyHex, messageHex, signatureHex)
