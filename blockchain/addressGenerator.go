...
// ComputeArwenScAddress will return the smart contract address that will be generated by the Arwen VM providing
// the owner's address & nonce
func (ag *addressGenerator) ComputeArwenScAddressOK(address []byte, nonce uint64) ([]byte, error) {

	scAddressBytes, err := ag.blockChainHook.NewAddress(address, nonce, factory.ArwenVirtualMachine)
	if err != nil {
		return nil, err
	}

	return scAddressBytes, nil
}
